...
class Connection(AbstractChannel):
    ...
    def _x_open(self, virtual_host, capabilities=''):
        ...
        PARAMETERS: virtual_host: shortstr
                ...
                RULE:
                    ...
                    If the server supports multiple virtual hosts, it MUST enforce a full separation of exchanges,
                    queues, and all associated entities per virtual host. An application, connected to a specific
                    virtual host, MUST NOT be able to access resources of another virtual host.
                ...
                RULE:
                    ...
                    The server MAY configure arbitrary limits per virtual host, such as the number of each type of
            ...
            capabilities: shortstr
                ...
                The client may specify a number of capability names, delimited by spaces.  The server can use this
                string to how to process the client's connection request.
        """
        args = AMQPWriter()
    ...
    def _start(self, args):
        ...
        RULE:
            ...
            If the client cannot handle the protocol version suggested by the server it MUST close the socket
            connection.

        RULE:

            The server MUST provide a protocol version that is lower than or equal to that requested by the client in
            the protocol header. If the server cannot support the specified protocol it MUST NOT send this method, but
            MUST close the socket connection.

        PARAMETERS: version_major: octet
    ...
    def _x_start_ok(self, client_properties, mechanism, response, locale):
        ...
        PARAMETERS: client_properties: table
